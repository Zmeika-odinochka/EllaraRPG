...
Теперь есть городской маршрут, оружейная и покупаемый кинжал с экипировкой.
Рост навыков и боевая добыча ещё впереди.
...
Формат сохранений 5 загружает прежние версии 1–4 с пустым слотом оружия.
...
Победа сохраняется, боевых наград пока нет. Старые слоты работают; в них ползун
ещё не побеждён. После победы повторить бой можно загрузкой слота до победы.
