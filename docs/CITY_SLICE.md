...
В городском этапе формат стал 5; текущий P3 использует формат 6. Переходы автосохраняются тихо, ошибки
...
остановиться для прохождения Филиппом. Позднее отдельное ночное задание разрешило
P3 и книжную лавку на торговой улице, западнее оружейной (дверь 144,236).
В лавке Эда и три книги; остальная сеть города сохранена. tests/city.gd включает
оба направления нового перехода; tests/progression.gd проверяет покупки/изучение.
Подробности — [PROGRESSION_P3.md](PROGRESSION_P3.md). Храмовые услуги, ремесло,
новые враги и дальнейшие магазины не разрешены.
