...
кинжала 6. GameState.weapon_base_damage() предоставляет значение будущему бою.
Это начальное соотношение данных, а не настройка врагов или обещание конкретного
числа ударов. Существующий post_combat не подключён к этому значению и не изменён.
Принцип дальнейшего баланса: голыми руками победа возможна, но медленна;
кинжал должен заметно менять практическую эффективность.
